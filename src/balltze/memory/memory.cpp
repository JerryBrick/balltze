...
namespace Balltze::Memory {
    ...
    static bool find_core_signatures() {
        ...
        FIND_SIGNATURE("rcon_message_function_call", 0x0, {/*0xE8*/ -1, -1, -1, -1, -1, 0x83, 0xC4, 0x08, 0x83, 0xC4, 0x58, 0xC3, 0x8B, 0xC2, 0xE8, -1, -1, -1, -1, 0x83, 0xC4, 0x58, 0xC3});
    ...
    static bool find_client_signatures() {
        ...
        FIND_SIGNATURE("d3d9_set_video_mode", 0x0, {0xE9, -1, -1, -1, -1, 0x90, 0x85, 0xC0, 0x7D, 0x29, 0x46});
        ...
        FIND_SIGNATURE("render_ui_function_call", 0xC, {0xE8, -1, -1, -1, -1, 0xE8, -1, -1, -1, -1, 0x8B, 0xC5, 0xE8, -1, -1, -1, -1, 0x66, 0x83, 0x3D, 0x82, 0xC5, 0x75, 0x00, 0xFF});
        FIND_SIGNATURE("render_ui_function", 0x0, {0x33, 0xc9, 0x83, 0xec, 0x14, 0x66, 0x3d, 0xff, 0xff, 0x0f, 0x94, 0xc1, 0x53, 0x33, 0xdb, 0x49, 0x23, 0xc8, 0x66, 0x89, 0x0d, 0xf0, 0x53, 0x81, 0x00});
        ...
        /** Loading screen */
        FIND_SIGNATURE("loading_screen_handler", 0x0, {0xA1, -1, -1, -1, -1, 0x81, 0xEC, 0x18, 0x04, 0x00, 0x00, 0x57, 0x33, 0xFF, 0x3B, 0xC7});
        FIND_SIGNATURE("loading_screen_render_function", 0x0, {0xA1, -1, -1, -1, -1, 0x81, 0xEC, 0x18, 0x04, 0x00, 0x00, 0x57, 0x33, 0xFF, 0x3B, 0xC7});
        FIND_SIGNATURE("loading_screen_background_render_call", 0x0, {-1, -1, -1, -1, -1, 0x83, 0xC4, 0x0C, 0x55, 0x6A, 0x02, 0x6A, 0xFF, 0x8D, 0x44, 0x24, 0x24});
